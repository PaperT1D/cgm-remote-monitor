...
function init(ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
    	...
    	reasonconf.push({ name: translate('Eating Soon'), targetTop: 80, targetBottom: 80, duration: 120 });
    	reasonconf.push({ name: translate('Activity'), targetTop: 140, targetBottom: 120, duration: 120 });
    	reasonconf.push({ name: translate('ToB'), targetTop: 130, targetBottom: 130, duration: 360 });   
    }
